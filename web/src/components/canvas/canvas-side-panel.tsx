...
function buildInsertPayload(asset: Asset): InsertAssetPayload {
    ...
    return { kind: "image", dataUrl: asset.data.dataUrl, coverUrl: asset.coverUrl, storageKey: asset.data.storageKey, title: asset.title, width: asset.data.width, height: asset.data.height, bytes: asset.data.bytes, mimeType: asset.data.mimeType };
}
